...
class GDMPMultiplayerLayer : public cocos2d::CCLayer {
protected:
    virtual bool init();
...
public:
    static GDMPMultiplayerLayer* create();
...
protected:
    ...
    GDMPMultiplayerLayer* theOriginalLayer;

    bool init(Room info, GDMPMultiplayerLayer* originalLayer, CCSize const& size, bool selected);

    virtual void FLAlert_Clicked(FLAlertLayer*, bool btn2);

public:
    static RoomCell* create(Room info, GDMPMultiplayerLayer* originalLayer, CCSize const& size, bool selected);
